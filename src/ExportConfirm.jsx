...
const ExportConfirm = memo(({
  ...
  const onPreserveMovDataHelpPress = () => {
  ...
  const onSegmentsToChaptersHelpPress = () => {
  ...
  const onPreserveMetadataOnMergeHelpPress = () => {
  ...
  const onOutSegTemplateHelpPress = () => {
  ...
  const onAvoidNegativeTsHelpPress = () => {
